...
def cvt_annotations(devkit_path, years, split, out_file):
    ...
    for year in years:
        ...
        img_paths = [
            f'VOC{year}/JPEGImages/{img_name}.png' for img_name in img_names
        ]
...
def parse_args():
    ...
    parser.add_argument('-o', '--out-dir', help='output path', default='data_list/voc_semi')
    parser.add_argument(
        '--out-format',
        default='pkl',
        choices=('pkl', 'coco'),
