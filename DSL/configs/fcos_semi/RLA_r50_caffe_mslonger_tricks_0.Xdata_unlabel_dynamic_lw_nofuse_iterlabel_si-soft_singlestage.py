model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        pretrained='/public/home/lsy/myj/code_dsl/DSL/workdir_coco/r50_caffe_mslonger_tricks_0.1data/epoch_100.pth'),
    neck=dict(
        type='FPN',
...
data_root = '/public/home/lsy/myj/code_dsl/data/semicoco/'
